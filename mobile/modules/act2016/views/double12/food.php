...
<html>
    ...
    <body ontouchstart="" class="food-bg sp-bg">
        <section class="ui-container">
            <section id="grid">
                <div class="demo-block">
                    <section class="ui-placehold-img img-p7">
                        <span id="food"></span>
                    </section>
                    <section class="ui-placehold-img img-p2">
                        <span class="wave-bk"><img src="http://img.ftzmall.com/wap_themes/default/images/mobile/img/shake/food-bk.png"></span>
                    </section>
                    <?= mobile\widgets\commercial\CommercialWidget::widget(["adClass" => '\common\models\commercial\ProductAdvertisement', "adId" => 8086401, 'tpl' => '12active2row']) ?>
                       
                    <section class="ui-placehold-img img-p2">
                        <span class="wave-bk"><img src="http://img.ftzmall.com/wap_themes/default/images/mobile/img/shake/food-bk1.png"></span>
                    </section>
                    <?= mobile\widgets\commercial\CommercialWidget::widget(["adClass" => '\common\models\commercial\ProductAdvertisement', "adId" => 8086402, 'tpl' => '12active2row']) ?>
                </div>
            </section>
     ...
     <a href="/act2016/double12/luxury.html"><div class="ui-col-100 hg-65 margin-bot4"> <span style="background-image:url(http://img.ftzmall.com/wap_themes/default/images/mobile/img/zhc1-img/zhc-24.png)"></span> </div></a>
        ...
        $(function(){
           ...
           $('ul.ui-grid-halve').last().find('.full-cut').html('满128减40'); 
        });
        </script>
