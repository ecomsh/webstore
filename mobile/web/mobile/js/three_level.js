/*
 * Three level province,city,country
 *
 * By Xu Jia
*/
var jsonData = [{  
...
function initCountry(){
	...
	for(var i=0;i<jsonData.length;i++){
		proviceStr += "<option value='"+jsonData[i].code+"'>"+jsonData[i].name+"</option>";
	}
	...
	provice.bind("change",function(){
		...
		$.each(jsonData[index].sub,function(index,items){
			city.empty();
			cityStr += "<option value='"+items.code+"'>"+items.name+"</option>";
			city.append(cityStr);
		})
		changeLocale();
	});
	...
	function changeLocale(){
		...
		$.each(jsonData[index].sub[index2].sub,function(index,items){
			locale.empty();
			localeStr += "<option value='"+items.code+"'>"+items.name+"</option>";
