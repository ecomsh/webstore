                        ...
                        <div class="full-padding">
                            ...
                            <div class="page pt-pic" style="position:relative;z-index:0;">
                                ...
                                <div data-am-widget="slider" class="am-slider am-slider-default swiper-container" data-am-slider='{&quot;directionNav&quot;:false}' data-am-flexslider="{playAfterPaused: 3000}">
                                    <ul class="am-slides">
                                        <li>
                                            <a href=""><img src="<?=Url::to('@web/mobile/images/ad1.jpg', true)?>"></a>
                                        </li>
                                        <li>
                                            <a href=""><img src="<?=Url::to('@web/mobile/images/ad3.jpg', true)?>"></a>
                                        </li>
                                        <li>
                                            <a href=""><img src="<?= Url::to('@web/mobile/images/b46b66dc6cfda7440e52b0a019218b9d4f1.jpg', true)?>"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
