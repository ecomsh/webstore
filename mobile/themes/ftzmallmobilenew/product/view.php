    ...
    <body>
        ...
        <footer class="ui-footer ui-footer-btn">
            <ul class="ui-tiled ui-border-t">             
                <li class="bg-red ui-border-r" style="width:80%" id="addtocart_box_1"><a href="javascript:void(0);" class="buynow show-skumapbox"/>加入购物车</a></li>
                ...
                <li class="ui-border-r bg-black" style="width:20%"><a id="cart-price" href="<?= Url::to(['cart/index']); ?>"><img src="<?=Url::to('@web/themes/wxnew/images/cart-bg.png', true)?>" style="margin-top:0.3em;"></a></li>
            </ul>
        </footer>
            ...
            <section id="slider">
                <div class="demo-item">               
                    <div class="demo-block">
                        <div class="ui-slider">
                            <ul class="ui-slider-content" style="width: 800%" id="picscroll">
                                <li><span style="background-image:url(<?= isset($desc['bigImage'])?Html::encode($desc['bigImage']):"" ?>)"></span></li>
                                <?php
                    ...
                    <div class="demo-block"> 
                        <div class="product-detail-box">
                            ...
                            <?php if(isset($brand["countryname"]) && $brand["countryname"]!=""): ?>
                             ...
                             <?php endif;?>   
                                <span id="brand-name" class="brand-g"><?= Html::encode($data['brand']['name']) ?></span></p>
                        ...
                        <div class="ui-tab">
                            ...
                            <ul class="ui-tab-content" style="width:200%">
                                <li>
                                    ...
                                    <h2 style="margin:0 auto;padding-top:2em;font-size:1em; text-align:center;border-bottom:1px solid #000; width:94%; padding-bottom:0.75em"><i class="icon-tag font-24 font-red"></i>&nbsp;&nbsp;商品信息&nbsp;&nbsp;<!--<i class="font-16 font-s">Product Introduction</i>--></h2>                                  
                                    <!-- <div id="wrapper">
                                        <div id="scroller"> 
                                            <div id="thelist">                                                
                                            </div>
                        ...
                        <div class="ui-dialog box-align-end">
                            <div class="ui-dialog-cnt">
                                ...
                                <div class="ui-form-item ui-border-t" <?php if($data['salesType']==1||$data['salesType']==2):?>style="display:none"<?php endif;?>>
                                    <div class="tax-box">
                                        <?php if($data['type']=="package"):?>
                                            <span class="tax-free" style="line-height:3em;margin-top:1.5em">组合</span><span>税费加入购物车后可见</span>
                                        <?php else:?>
                                            <span class="tax-free" style="line-height:3em;margin-top:1.5em">免</span><span>进口税</span><span class="tax">￥20.00</span><span>元/件， 进口税小于等于50元免征</span>                                            
                                        <?php endif;?>
                                    </div>
                                </div>
                                ...
                                <ul class="ui-tiled ui-border-t skumap-bottom">
                                    <li class="ui-border-r bg-red" style="width:80%;display:none" id="addtocart_box"><a id="addtocart" href="javascript:void(0);">加入购物车</a></li>
                                    <li class="ui-border-r bg-red" style="width:80%;display:none" id="buynow_box"><a id="buynow">立即购买</a></li>
                                    <li class="ui-border-r bg-red" style="width:80%;background-color:#ccc" id="addunabled_box"><a id="addunabled" style="color:#fff;font-size:1em;;line-height:45px">加入购物车</a></li>
                                    <li class="ui-border-r" style="width:80%;display:none;background-color:#ccc" id="adding_box"><a id="adding" style="color:#fff;font-size：1em;line-height:45px">正在加入购物车</a></li>
