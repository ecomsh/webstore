...
//                                 
                            ...
                            ?> 
                                ...
                                <div class="login-box">
                                    ...
                                    <div class="btn-bar mt20">
                                        <?= Html::hiddenInput('returnUrl', Yii::$app->request->get('returnUrl'))?>
                        ...
                        <a href="<?= Yii::$app->request->get('returnUrl') ? Yii::$app->request->get('returnUrl') : Url::to(['passport/createaddress']) ?>" style="margin-top:10px;">跳过，暂时不填写</a> 
                    </div>
                </div>
