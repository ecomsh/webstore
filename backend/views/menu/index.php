    ...
    <div ui-view="" autoscroll="false" class="content-wrapper ng-scope ng-fadeInUp">
        <div class="row">
            ...
            <div class="col-md-4">
                <?php
                if ($platform == '1')
                    echo Html::a('移动版', ['menu/platform', 'platform' => '2']);
                else
                    echo Html::a('PC版', ['menu/platform', 'platform' => '1']);
                ?>
            </div>
        </div>
        ...
        <div class="panel panel-default ng-scope">
            <div class="panel-heading">
                <?= Html::a('模板管理', ['cms/index']) ?>
                <?= \Yii::t('app', '导航管理'); ?>
            </div>
            <div class="panel-body">
                <?= Html::a(\Yii::t('app', '创建栏目'), ['create'], ['class' => 'btn btn-primary mb-sm']) ?>
                <?= Alert::widget(); ?>
                        ...
                        <table datatable="ng" class="row-border hover ng-isolate-scope dataTable no-footer" style="display: table;" id="DataTables_Table_0" role="grid">
                            <thead>
                                <tr role="row"><!--<th class="sorting_asc  sorting"  ...-->
                                    ...
                                    <th  tabindex="0" rowspan="1" colspan="1" style="width: 700px;"><?= \Yii::t('app', '栏目名'); ?></th>
