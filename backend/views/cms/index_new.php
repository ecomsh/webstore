...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" class="content-wrapper ng-scope ng-fadeInUp">
        <div >
          <small>请选择店铺:</small>
          <?= Html::dropDownList('CmsSearch[storeid]',
                                 $storeId,
                                 $storeIdList,
                                 ['id'=>'storeid_dropdowmlist','style'=>'width: 200px'])?>
        </div>
        <div class="row">
            <div class="col-md-8">
                        ...
                        <table datatable="ng" class="row-border hover ng-isolate-scope dataTable no-footer" style="display: table;" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                            <thead>
                                <tr role="row"><!--<th class="sorting_asc  sorting"  ...-->
                                    ...
                                    <th  tabindex="0" rowspan="1" colspan="1" style="width: 74px;"><?= \Yii::t('app', '在线预览'); ?></th>
                                    <th  tabindex="0" rowspan="1" colspan="1" style="width: 74px;"><?= \Yii::t('app', '活动'); ?></th>
                                    <th  tabindex="0" rowspan="1" colspan="1" style="width: 74px;"><?= \Yii::t('app', '发布状态'); ?></th>
                                    <th  tabindex="0" rowspan="1" colspan="1" style="width: 154px;"><?= \Yii::t('app', '日期'); ?></th>
                                    <th tabindex="0" rowspan="1" colspan="1" style="width: 366px;"><?= \Yii::t('app', '操作'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
