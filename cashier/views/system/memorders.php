...
<div class="main">
    ...
    <div class="system-right">
        ...
        <nav class="clearfix">
            <span class="current-info">本页订单数：<?= $dataProvider->getCount(); ?>个 | 本页支付金额汇总：￥<?= $totalPayAmount ?> | 本页分成金额汇总：￥<?= $totalrateAmount ?></span>
        <?=
        LinkPager::widget([
        ...
        <div class="chaxun">
            <a href="<?= Url::to(['system/dlmemorders', 'orderStatus'=> $orderStatus, 'order_time' => $order_time,  'startDate' => $startDate, 'endDate' => $endDate, 'totalCount' => $dataProvider->getTotalCount()])?>">下载查询结果 </a>
        </div>
    </div>
</div>
<script>
