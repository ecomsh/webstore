...
<div style = "width: 960px;" class = "member-main">
    <div>
        ...
        <p class = "admin-title admin-title2">您当前的预存款余额为：<span class = "point pr5"><?= $balance ?></span>|<a href = "<?= Yii::$app->params['baseUrl'] ?>user-deposit.html" class = "font-blue pl5">预存款充值 &gt;
                &gt;
            </a></p>
