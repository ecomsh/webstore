...
use frontend\assets\ftzmallnew\ProductAssetgai;
use yii\helpers\Html;
use yii\helpers\Url;
ProductAssetgai::register($this);
            ...
            <?php if ($product['definingAttributes'] && is_array($product['definingAttributes']) && $product['type']!="package")
            {
                foreach ($product['definingAttributes'] as $k => $arr):
                    ...
                    <div class="skumap-smallbox">
                       ...
                       <?php elseif ($arr['assignedValue'] && is_array($arr['assignedValue']) && !$product['isProductSku'] && $product['type'] == "item"):?>                  
