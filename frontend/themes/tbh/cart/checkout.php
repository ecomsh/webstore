...
<?php ActiveForm::end(); ?>
        ...
        <div class="product-listing">
            ...
            <?php if(isset(Yii::$app->params['sm']['cart']['store'][$orderType])){ ?>
            <p class="listing-table-title"><?=  Yii::$app->params['sm']['cart']['store'][$orderType]?></p>
            <?php } else {?>
            ...
            <ul>
                ...
                <li class="listing-explain clearfix">
                    ...
                    <div class="listing-total pull-right">
                        <div>商品总计：<span class="order-total">￥<?= $price['orderDetail']['originalPrice']+$newOfferPrice ?></span></div>
                        <div>
                            <span class="activity1 promotion-message">
                                <?php if(isset($price['orderDetail']['orderPromotionName'])){ ?>
                                您参加了 【<?= $price['orderDetail']['orderPromotionName']?>】 的活动
                                <?php } ?>
                            </span>
                            活动优惠：<span class="activity-span">-￥<?= $price['orderDetail']['promotion']+$newOfferPrice ?></span>
                        </div>
                        <div>
...
<script>
    ...
    var newOfferPrice = <?= Yii::$app->formatter->asDecimal($newOfferPrice) ?>;
