...
!function($){
	...
	// 默认模板
	var _dialogTpl='<div class="ui-dialog1">'+
...
function Scroll(el, options) {
	...
	if (this.options.role === 'slider') {
		...
		if (this.options.indicator) {
			var temp = '<ul class="ui-slider-indicators right4">';
...
// slide2
	...
	if (this.options.role === 'slider2') {
		...
		if (this.options.indicator) {
			var temp = '<ul class="ui-slider-indicators right45">';
...
Scroll.prototype = {
	...
	_end: function (e) {
		...
		// tab
		// ==========================
		if (this.options.role === 'tab' && $(event.target).closest('ul').hasClass('ui-tab-nav1')) {
