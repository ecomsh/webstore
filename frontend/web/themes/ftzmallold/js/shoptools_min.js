...
"ie6+";if(!Browser.ie)return!1;this._storage=(new Element("span")).setStyles({display:"none",behavior:"url('#default#userData')"}).inject(document.body);return this},setStorage:function(e,a){this._storage.setAttribute(e,a);this._storage.save("csbbc_VS");return!0},getStorage:function(e,a){this._storage.load("csbbc_VS");a(this._storage.getAttribute(e))},removeStorage:function(a){this._storage.removeAttribute(a);this._storage.save("csbbc_VS");return!0},clearStorage:function(){var a=new Date;a.setMinutes(a.getMinutes()-
1);this._storage.expires=a.toUTCString();this._storage.save("csbbc_VS");this._storage.load("csbbc_VS");return!0}},d={name:"openDatabase",init:function(){if(!window.openDatabase)return!1;this._storage=window.openDatabase("viewState","1.0","csbbc48 ViewState Storage",2E4);this._createTable();return this},setStorage:function(a,b){this._storage.transaction(function(c){c.executeSql("SELECT v FROM SessionStorage WHERE k = ?",[a],function(c,d){d.rows.length?c.executeSql("UPDATE SessionStorage SET v = ?  WHERE k = ?",
