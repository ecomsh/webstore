...
$(document).ready(
		function(){
             ...
             $(".getValiCode").click(function () {
                 ...
                 var verifycode = $("input#registeruserform-verifycode").val();	 

                if (phoneNumber === null || phoneNumber === '' || verifycode === null || verifycode === '') {
                    $("input#registeruserform-mobile").focus();
                    $("input#registeruserform-mobile").blur();
                    $("input#registeruserform-verifycode").focus();
                    $("input#registeruserform-verifycode").blur();
                    return false;
                }
                 ...
                 success: function(data) {
                     ...
                     if(mobile === undefined && verifyCode === undefined){
                    	 ...
                    	 if(verifyCode != undefined){
                    		 $("input#registeruserform-verifycode").focus();
                          	$(".field-registeruserform-verifycode .help-block-error").html(verifyCode);
                    	 }
...
//              	$("button#btn-vcode").removeAttr('onclick');
                 ...
                 $.ajax({
                     ...
                     success: function(data) {
                         ...
                         var obj = eval(data)
                         var vcerror = obj.verifyCodeError
                         if(vcerror != undefined){
                    		 $("input#registeruserform-verifycode").focus();
                          	$(".field-registeruserform-verifycode .help-block-error").html(vcerror);
                    	 }
             ...
             function getwdeccrcci(){
            	 return $.md5("HlI0O0XSUIICIXYSB"); 
             }
