...
<?php for ($i = 0; $i < count($items); $i++): ?>
    ...
    <div class="goods_pd">
        <a target="_blank" href="<?=$items[$i]->href ?>">
			<img class="small_goods" src="http://7xoo3k.com2.z0.glb.qiniucdn.com/pc-static-flag-<?=$country[0]?>.png" width="40" onerror="this.style.display='none'">
            <div class="goods_img_b">
                <img class="goods_img" src="<?=Tools::qnImg($items[$i]->productImage, 246, 256)?>" />
            </div>
            <p class="goods_pro"></p>
