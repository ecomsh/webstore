...
use common\helpers\hongbao\CommonUtil;
use common\helpers\hongbao\SDKRuntimeException;
use common\helpers\hongbao\MD5SignUtil;
...
class WxHongBaoHelper
{
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT,dirname(__FILE__).DIRECTORY_SEPARATOR.YII_ENV.'_zhengshu'.DIRECTORY_SEPARATOR.'apiclient_cert.pem');
 		curl_setopt($ch,CURLOPT_SSLKEY,dirname(__FILE__).DIRECTORY_SEPARATOR.YII_ENV.'_zhengshu'.DIRECTORY_SEPARATOR.'apiclient_key.pem');
 		curl_setopt($ch,CURLOPT_CAINFO,dirname(__FILE__).DIRECTORY_SEPARATOR.YII_ENV.'_zhengshu'.DIRECTORY_SEPARATOR.'rootca.pem');
